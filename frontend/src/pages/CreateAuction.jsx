    ...
    <article className="relative w-full min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 lg:pl-72 overflow-hidden py-8">
      ...
      >
        <motion.div variants={itemVariants}>
          <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-white via-indigo-200 to-white bg-clip-text text-transparent mb-8">
            Create Auction
          </h1>
        </motion.div>
        ...
        >
          <div className="flex flex-col gap-6 sm:flex-row">
            <div className="flex flex-col sm:flex-1">
              <label className="text-[16px] text-indigo-300 font-medium mb-2">Title</label>
              <input
                type="text"
                value={title}
            ...
            <div className="flex flex-col sm:flex-1">
              <label className="text-[16px] text-indigo-300 font-medium mb-2">Category</label>
              <select
                value={category}
          ...
          <div className="flex flex-col gap-6 sm:flex-row mt-6">
            <div className="flex flex-col sm:flex-1">
              <label className="text-[16px] text-indigo-300 font-medium mb-2">Condition</label>
              <select
                value={condition}
            ...
            <div className="flex flex-col sm:flex-1">
              <label className="text-[16px] text-indigo-300 font-medium mb-2">Starting Bid</label>
              <input
                type="number"
                value={startingBid}
          ...
          <div className="flex flex-col gap-6 mt-6">
            <div className="flex flex-col w-full">
              <label className="text-[16px] text-indigo-300 font-medium mb-2">Description</label>
              <textarea
                value={description}
            ...
            <div className="flex items-center justify-center w-full">
              ...
              >
                ...
                <div className="relative flex flex-col items-center justify-center pt-5 pb-6 px-4">
                  ...
                  <p className="mb-2 text-lg text-indigo-300 text-center">
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-gradient-to-r from-indigo-500 to-purple-500 font-semibold hover:from-indigo-600 hover:to-purple-600 text-xl transition-all duration-300 py-3 px-6 rounded-xl text-white w-full sm:w-[280px] mx-auto lg:w-[640px] my-4 shadow-lg shadow-indigo-500/20"
          >
            {loading ? (
