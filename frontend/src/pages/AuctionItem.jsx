        ...
        {loading ? (
          ...
          <div className="flex gap-4 flex-col lg:flex-row">
            ...
            <div className="flex-1">
              ...
              <div className="bg-[#D6482B] py-4 text-[16px] md:text-[24px] font-semibold px-4 flex items-cetner justify-between">
                {Date.now() >= new Date(auctionDetail.startTime) &&
                Date.now() <= new Date(auctionDetail.endTime) ? (
                  <>
                    ...
                    <button
                      className="p-4 text-white bg-black rounded-full hover:transition-all duration-200 hover:bg-[#222]"
                      onClick={handleBid}
                    >
                      <RiAuctionFill />
                    </button>
                  ...
                  <p className="text-white font-semibold text-xl">Auction has been not started yet</p>
                ) : (
