...
const HowItWorks = () => {
    ...
    return (
        <div className="ml-[280px] min-h-screen bg-[#1a1f27] p-8">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-4xl font-bold mb-12 animate-fade-in bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                    How Bid Bazzar Works
                    <div className="h-1 w-24 bg-gradient-to-r from-indigo-400 to-purple-400 mt-2 animate-width-expand"></div>
                </h1>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    {steps.map((step, index) => (
                        <div 
                            key={index} 
                            className="bg-[#1e242e] rounded-lg p-6 hover:bg-[#252b36] transition-all duration-500 border border-gray-800 hover:border-[#ee4d2d] group animate-slide-up"
                            style={{
                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className="flex-shrink-0">
                                    <div className="w-12 h-12 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-lg flex items-center justify-center text-white text-xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                                        {step.icon}
                                    </div>
                                </div>
                                <div className="transform transition-all duration-300 group-hover:translate-x-2">
                                    <div className="text-[#ee4d2d] text-sm font-medium mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        Step {(index + 1).toString().padStart(2, '0')}
                                    </div>
                                    <h3 className="text-white text-xl font-semibold mb-2 group-hover:text-[#ee4d2d] transition-colors duration-300">
                                        {step.title}
                                    </h3>
